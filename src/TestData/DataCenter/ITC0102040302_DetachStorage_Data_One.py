...
expected_status_code_detach_sd_fail = 409               # 将存储域从数据中心分离，失败，返回状态码
expected_info_detach_sd_fail = '''
<fault>
    <reason>Operation Failed</reason>
    <detail>[Cannot remove the master Storage Domain from the Data Center without another active Storage Domain to take its place.
-Either activate another Storage Domain in the Data Center, or remove the Data Center.]</detail>
</fault>
'''