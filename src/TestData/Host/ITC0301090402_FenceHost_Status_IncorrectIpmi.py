...
host1_name = 'node-ITC0301090402-1'
host2_name = 'node-ITC0301090402-2-pm'
xml_host1_info = '''
<host>
    <name>%s</name>
    <address>%s</address>
...
expected_status_code_fence_status = 200         # IPMI配置正确时，返回状态码
expected_info_fence_status = '''
<action>
    <fence_type>status</fence_type>
    <status>
        <state>failed</state>
    ...
    <fault>
        <reason>Getting status of IPMI:%s...Chassis power = Unknown
Failed</reason>
    </fault>
</action>
''' % host2['IMM']['ip']
